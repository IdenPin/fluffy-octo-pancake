...
/***/ function(module, exports, __webpack_require__) {
	...
	var data = __webpack_require__(5)().list;
	$(document).ready(function () {
	    var tpl = '';
	    $.each(data, function (i, v) {
	        tpl += '' + '<div id="data-card">' + '<div class="name">姓名:' + v.name + '</div>' + '<div class="avator">' + '<img src="' + v.avator + '"/>' + '</div>' + '<div class="nice">昵称:' + v.nick + '</div>' + '<div class="constellation">星座:' + v.constellation + '</div>' + '<div class="time">时间:' + v.time + '</div>' + '<div class="content">主题内容:' + v.content + '</div>' + '</div>';
	    });
	    $('#data').html(tpl);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	module.exports = function () {
	    var Mock = __webpack_require__(6);
	    Mock.Random.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! mockjs 02-06-2015 22:03:43 */
	/*! src/mock-prefix.js */
	/*!
	    Mock - 模拟请求 & 模拟数据
